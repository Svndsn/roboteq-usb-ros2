...
bool RosRoboteqDrv::Initialize()
{
    try
    {
        ...
        _sub_wheel = _nh->create_subscription<roboteq_node_ros2::msg::WheelsMsg>(
            "cmd_wheel", 10, std::bind(static_cast<void (RosRoboteqDrv::*)(const roboteq_node_ros2::msg::WheelsMsg::SharedPtr)>(&RosRoboteqDrv::CmdVelCallback), this, std::placeholders::_1));
    }
